...
Before running the project, make sure to configure the database connection in the following file: src/app/plugin/postgres.ts.
You will need to provide the correct values for the PostgreSQL database connection, including the ID, password, and database name.
...
API Endpoints   Location src/app/routes/todos/todo.ts
